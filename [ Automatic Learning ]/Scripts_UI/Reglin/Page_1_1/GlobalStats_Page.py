...
from Scripts_UI.Reglin.Page_1_2 import NaN_Page
...
from Scripts_UI.Reglin.Page_1.DataFrame_Viewer import *
...
class Global_Stats(QMainWindow):
	...
	def __init__(self):
		...
		loadUi('Scripts_UI/Reglin/Page_1_1/Global_Stats.ui', self) # Load UI File
