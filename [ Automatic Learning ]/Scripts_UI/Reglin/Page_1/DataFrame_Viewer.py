...
from Scripts_UI.Reglin.Page_0 import Dataset_Selection_Mode
...
class Show_Datas(QMainWindow):
	...
	def __init__(self):
		...
		loadUi('Scripts_UI/Reglin/Page_1/DataFrame_Viewer.ui', self) # Load UI File
		...
		if self.mode == 'default':
			...
			# Define path
			path = 'Datasets/Reglin/50_Startups.csv'
...
# --------------------------- Plot Page ----------------------------- #			
	...
	def from_df_to_fit(self):
		self.hide()
		self.window = Settings_Reglin.Load_Settings()
		Main_Page.Main_Page.style(self)
