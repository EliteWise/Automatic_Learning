...
from Scripts_UI.KNN.Page_1_1 import GlobalStats_Page
from Scripts_UI.CNN import Pipeline_CNN
from Scripts_UI.KNN.Page_2 import Plot_Page
from Scripts_UI.KNN.Page_4 import Settings_KNN
from Scripts_UI.KNN.Page_0 import Dataset_Selection_Mode
...
class Show_Datas(QMainWindow):
	...
	def __init__(self):
		...
		loadUi('Scripts_UI/KNN/Page_1/DataFrame_Viewer.ui', self) # Load UI File

		# --------------- Default Dataset Mode --------------- #

		global get_df

		mode = Dataset_Selection_Mode.Select_Mode.stock_mode(self)
		...
		if mode == 'default':
			...
			# Define path
			path = 'Datasets/KNN/Cancer_du_sein_benin_ou_pas.csv'
...
# --------------------------- Plot Page ----------------------------- #			
	...
	def from_df_to_fit(self):
		self.hide()
		self.window = Settings_KNN.Load_Settings()
		Main_Page.Main_Page.style(self)
