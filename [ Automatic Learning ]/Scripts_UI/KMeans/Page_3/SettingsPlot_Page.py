...
class Settings(QMainWindow):
	...
	def __init__(self):
		...
		loadUi('Scripts_UI/KMeans/Page_3/Settings_Plot.ui', self) # Load UI File
...
# ---------------------------------- Show Advanced Plot ----------------------------------------- #
		...
		if self.type_plot == 'scatter matrix':
		...
		elif self.type_plot == 'dindrogram':
		...
		elif self.type_plot == 'scatter plot':
