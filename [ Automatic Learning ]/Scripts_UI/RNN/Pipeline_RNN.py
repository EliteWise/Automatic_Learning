...
from keras.layers import Activation, Dropout, Flatten, Dense, SimpleRNN
...
#---------------------------------------------------------
	...
	def define_model(self):
		...
		model = Sequential()
		model.add(SimpleRNN(100, activation='relu', input_shape=(30, 1), return_sequences=True))
		model.add(SimpleRNN(100, activation='relu'))
		model.add(Dense(1))

		optim_sgd = optimizers.SGD(lr=0.005)
