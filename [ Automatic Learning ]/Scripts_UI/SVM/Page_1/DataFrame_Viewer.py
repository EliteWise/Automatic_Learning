...
from Scripts_UI.SVM.Page_1_1 import GlobalStats_Page
from Scripts_UI.CNN import Pipeline_CNN
from Scripts_UI.SVM.Page_2 import Plot_Page
from Scripts_UI.SVM.Page_4 import Settings_SVM
from Scripts_UI.SVM.Page_0 import Dataset_Selection_Mode
...
class Show_Datas(QMainWindow):
	...
	def __init__(self):
		...
		loadUi('Scripts_UI/SVM/Page_1/DataFrame_Viewer.ui', self) # Load UI File
		...
		if self.mode == 'default':
			...
			# Define path
			path = 'Datasets/SVM/Billet_de_banque_true_or_false.csv'
...
# --------------------------- Plot Page ----------------------------- #			
	...
	def from_df_to_fit(self):
		self.hide()
		self.window = Settings_SVM.Load_Settings()
		Main_Page.Main_Page.style(self)
